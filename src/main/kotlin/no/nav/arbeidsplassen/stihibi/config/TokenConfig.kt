package no.nav.arbeidsplassen.stihibi.config

import io.javalin.http.Context
import no.nav.arbeidsplassen.stihibi.KONSUMENT_ID_MDC_KEY
import no.nav.arbeidsplassen.stihibi.sikkerhet.AzureClientCredentialsKlient
import no.nav.arbeidsplassen.stihibi.sikkerhet.AzureOBOKlient
import no.nav.arbeidsplassen.stihibi.sikkerhet.Fodselsnummer
import no.nav.arbeidsplassen.stihibi.sikkerhet.TokendingsKlient
